...
public class Bot {
    ...
    @Command(aliases = {"хочупирожок"},
            args = "",
            description = "")
    public String wantMiniCake(String[] args) { return "хоти!"; }

    @Command(aliases = {"лицкевичклассный"},
            args = "",
            description = "")
    public String lickevichTop(String[] args) { return "согласен!"; }
